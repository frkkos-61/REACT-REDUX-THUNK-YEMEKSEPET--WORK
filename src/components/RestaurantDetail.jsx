...
//*Verileri başka bir yerde kullanmayacağımız için state tutmalıyız, store değil
const RestaurantDetail = () => {
  const [restaurant, setRestaurant] = useState(null);
  const { id } = useParams();
  //*Url parametrelerine erişmek için useParams
        ...
        <div className="text-red-500 flex gap-4">
          ...
          <p className="flex items-center gap-2">
            ...
            <span className="text-gray-700">
              min {restaurant.estimatedDelivery} TL
            </span>
          </p>
        </div>
